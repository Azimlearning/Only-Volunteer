  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: '/finder',
          builder: (_, __) => const AidFinderScreen(),
        ),
        GoRoute(
          path: '/drives',
          builder: (_, __) => const DonationDrivesScreen(),
        ),
        GoRoute(
          path: '/create-drive',
          builder: (_, __) => const CreateDriveScreen(),
        ),
        GoRoute(
          path: '/opportunities',
          builder: (_, __) => const VolunteerListingsScreen(),
        ),
        GoRoute(
          path: '/map',
          builder: (_, __) => const OpportunitiesMapScreen(),
        ),
        GoRoute(
          path: '/my-activities',
          builder: (_, __) => const MyActivitiesScreen(),
        ),
        GoRoute(
          path: '/feed',
